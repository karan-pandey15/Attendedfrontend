...
//       >
//         <div className="flex justify-between items-center w-[95%] py-3 flex_column">
...
//             />
//             {/* <button
//               className="text-white search_bar_button"
//               style={{ backgroundColor: "#F3A847", padding: "4px 6px" }}
//             >
//               Search
//             </button> */}
//             {searchTerm && (
...
//               <span className="text-white text-lg flex justify-center items-center">
